 ...
 * 功能：管理员对标签的增删改查操作
 */
@Tags({@Tag(name = "后台标签管理", description = "管理员标签CRUD接口")})
@RestController
...
public class AdminTagController {
    ...
    @PostMapping
    public Result<Void> createTag(@RequestBody com.xilei.blog.entity.Tag tag) {
    ...
    @PutMapping
    public Result<Void> updateTag(@RequestBody com.xilei.blog.entity.Tag tag) {
